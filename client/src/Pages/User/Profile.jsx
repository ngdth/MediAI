...
//     const [showChangePassForm, setShowChangePassForm] = useState(false); // Kiểm tra khi nào hiện form đổi mật khẩu
...
//         setShowChangePassForm(true); // Chuyển sang form đổi mật khẩu
//     };

//     // Hàm trở lại form profile
//     const handleBackToProfile = () => {
//         setShowChangePassForm(false); // Quay lại form Profile
//     };
...
//                                 {/* Kiểm tra xem có hiện form đổi mật khẩu không */}
//                                 {showChangePassForm ? (
//                                     <ChangePassForm userId={user._id} />
//                                 ) : (
