...
import { registerUser, loginUser, verifyAccount, sendOTP, resetPassword, deleteUnverifiedUser } from "../controllers/auth/authController";
...
router.delete("/deleteUnverify", deleteUnverifiedUser);
